...
public class Login_IU extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtDni)
                    .addComponent(txtClave, javax.swing.GroupLayout.DEFAULT_SIZE, 445, Short.MAX_VALUE))
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        if (txtDni.getText().length() > 0) {
            ...
            if (txtClave.getText().length() > 0) {
                ...
                UsuarioBD oUsusarioBD = new UsuarioBD();
                List<Usuario> lista_usuarios = oUsusarioBD.login(dni, clave);
    ...
    private void txtDniFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtDniFocusGained
        ...
        txtDni.setBackground(Color.ORANGE);
    ...
    private void txtClaveFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtClaveFocusGained
        ...
        txtClave.setBackground(Color.ORANGE);
